# Test Case: TC-promo-bva-002

**Title:** `TC-promo-bva-002.md`: Too high value
...
Chosen partition value: max-valid: (74,**75**,76)

## Steps

1. Load promo code discount field
2. Attempt discount code: 74
3. Clear discount field
4. Attempt discount code: 75
5. Clear discount field
6. Attempt discount code: 76
