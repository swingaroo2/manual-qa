...
**Title:** (p7/2) blocked username + valid password
...
User credentials are rejected. User is presented with error message *"Epic sadface: Sorry, this user has been locked out."*.
